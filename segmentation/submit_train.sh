...
#SBATCH --output=train_1.txt  # 스크립트 실행 결과 std output을 저장할 파일 이름
...
srun python train.py configs/pascal_context/mask2former_beit_adapter_base_480_40k_pascal_context_59_ss.py --work-dir test_1